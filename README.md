...
6. Data Development
   ...
   ```
   For this project I used only 100000 records due to memory issue with mage-ai, but actual size is more than 3 million records(You can process all data if you have more than 16GB of RAM).
